				...
				<table class="table table-condensed table-hover">
					<thead>
						<tr class="cart_menu">
							...
							<th class="address">Transaction id</th>
							<th class="product">Food id</th>
							<th class="amount">Total amount</th>
							<th class="Delivery status">Status</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="address"> <?php echo $row['transaction_id']?></td>
							...
							<td class="edit"><a class="al" href="seller_del_edit.php?&id= <?php echo $row['id']; ?>&delivery=<?php echo $row['status']; ?> "><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
						</tr>
						<?php } ?>
					</tbody>
                  <?php   } ?>	
