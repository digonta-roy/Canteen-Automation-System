...
<html lang="en">
	...
	<body>
		...
		if($emailcount){
			...
			$_SESSION['idd'] = $email_pass['id'];
			$_SESSION['namee'] = $email_pass['name'];
			$_SESSION['emaill'] = $email_pass['email'];
			$_SESSION['nmbrr'] = $email_pass['contact'];
			$_SESSION['addresss'] = $email_pass['address'];
			...
			if($pass_decode){
			  ?>
				<script>
					...
					location.replace("seller_dashboard.php");
				</script>
			  <?php
				}else{
				?>
							...
							<form action="#" method="post">
								...
								<div class="card-footer text-center">
									<div class="form-group">
										...
										<p class="already">Not a member? <span><a class="al" href="seller_registration.php">signup here</a></span></p>
								</form>
							</div>
						</div>
					</div>
