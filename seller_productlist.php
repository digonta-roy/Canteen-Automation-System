				...
				<table class="table table-condensed table-hover">
					...
					<tbody>
						...
						<td class="image"> <?php echo "<img src='img/".$row['image']."'>" ?></td>
							...
							<td class="edit"><a class="al" href="seller_pro_edit.php?id= <?php echo $row['id']; ?> & nm=<?php echo $row['name']; ?> &price=<?php echo $row['price']; ?>  "><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
							<td class="delete"><a class="al" href="seller_pro_delete.php?id= <?php echo $row['id']; ?> & nm=<?php echo $row['name']; ?> &price=<?php echo $row['price']; ?>  "><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
						</tr>
						<?php } ?>
					</tbody>
                  <?php   } ?>	
